...
class CORE_EXPORT Object {
  public:
    ...
    */
    ...
    /*!
    Returns a constant reference (read-only) to the vector of faces of the
    object.
    */
    const vector<Face> &faces() const;

    /*!
    Returns a constant reference (read-only) to the vector of vertices of the
    object.
    */
    ...
    If vertices are modified, computeNormals() and computeBoundingBox() methods
    should be called to update per-face normals and the object's bounding box.
    */
